        ...
        suboptions:
          host1:
            ...
            suboptions:
              ...
              module:
                description:
                  - Specifies whether to send syslog messages generated by a specific module or module group to the
                    specified syslog server (host 1 through host 5).
                  - If a module group is specified, messages generated by all the modules included in the group are
                    enabled for logging and routed to the syslog server.
                required: false
                default: all
                choices:
                - all
...
- name: alteon configuration command
  radware.radware_alteon.alteon_config_system_logging:
    provider:
      server: 192.168.1.1
      user: admin
      password: admin
