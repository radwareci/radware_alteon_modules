  ...
  parameters:
    ...
    suboptions:
      ...
      authentication_failure_traps:
        description:
          - Specifies whether the SNMP entity is permitted to generate authenticationFailure traps. The value of this
            object overrides any configuration information. As such, it provides a means whereby all
            authenticationFailure traps may be disabled.
          - Note that it is strongly recommended that this object be stored in non-volatile memory so that it remains
            constant across re-initializations of the network management system.
        required: false
        default: null
        choices:
        - enabled
      ...
      system_name:
        description:
          - An assigned name for this managed node. By convention, this is the node fully-qualified domain name. If the
      ...
      system_location:
        description:
          - The physical location of this node (for example, 'telephone closet 3rd floor'). If the location is unknown,
      ...
      system_contact:
        description:
          - The textual identification of the contact person for this managed node together with information on how to
            contact this person. If no contact information is known, the value is the zero-length string.
        required: false
        default: disabled
        type: str
notes:
...
- name: alteon configuration command
  radware.radware_alteon.alteon_config_system_snmp:
    provider:
      server: 192.168.1.1
      user: admin
      password: admin
