...
options:
  ...
  parameters:
    ...
    suboptions:
      ...
      fe_ssl_encryption:
        description:
          - Specifies whether to establish an SSL connection with the client and allow decryption/encryption of client
            traffic.
          - C(disabled) No decryption/encryption on the client-side connection.
          - C(enabled) The SSL connection is established and traffic is decrypted/encrypted on the client-side
            connection
          - C(connect) he SSL connection is established after clear-text HTTP Connect request is received and answered.
            This option is relevant only for outbound SSL Inspection scenarios where Alteon is installed as the
            HTTPS proxy for the clients.
          - For other (non-HTTP) traffic, the SSL connection is established a after clear-text "starttls" request is
      ...
      fe_intermediate_ca_chain_name:
        description:
          - Specifies the Intermediate CA certificate name or certificate chain (group) to be sent to the client
            together with the server certificate to construct the trust chain to the user's trusted CAs.
        required: false
        default: null
        type: str
      fe_intermediate_ca_chain_type:
        description:
          - Specifies the Intermediate CA certificate or certificate chain (group) to be sent to the client together
            with the server certificate to construct the trust chain to the user's trusted CAs.
        required: false
        default: null
        choices:
        - group
      ...
      be_ssl_encryption:
        description:
          - Specifies whether to establish an SSL connection towards the server and allow decryption/encryption
            of client traffic.
        required: false
        default: enabled
        choices:
      ...
      be_client_cert_name:
        description:
          - Specifies the client certificate that should be used when the server requests from the client (Alteon)
      ...
      be_auth_policy_name:
        description:
          - Specifies how server certificate authenticity should be checked, if at all. Select an Authentication
            Policy of type Server.
        required: false
        default: null
        type: str
      be_include_sni:
      ...
      pass_ssl_info_ssl_ver_header_name:
        description:
          - Specifies what header name to use when passing the SSL version to the back-end servers to the back-end
            servers.
        required: false
        default: SSL-Version
        type: str
      ...
      pass_ssl_info_cipher_bits_header_name:
        description:
          - Specifies what header name to use when passing the key length for the symmetric cipher negotiated
      ...
      pass_ssl_info_cipher_bits_header:
        description:
          - Specifies whether to pass the key length for the symmetric cipher negotiated (for example, 128 bits if
            AES128 was selected) to the back-end servers.
        required: false
        default: disabled
        choices:
        - enabled
      ...
      pass_ssl_info_add_front_end_https_header:
        description:
          - Specifies whether to add the Front-End HTTPS header to communicate to the back-end servers that the
            connection from the client is over HTTPS.
        required: false
        default: disabled
        choices:
        - enabled
