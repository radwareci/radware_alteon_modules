    ...
    suboptions:
      ip4_routes:
        ...
        suboptions:
          ...
          interface:
            description:
              - The IP interface of this route. Alteon uses the IP address of the specified interface as the source IP
                address when doing the routing.
            required: false
            default: null
            type: int
      ip6_routes:
        ...
        suboptions:
          ...
          vlan:
            description:
              - The VLAN of this route. Alteon uses the IP address of the specified VLAN as the source IP address when
                doing the routing.
            required: false
            default: null
            type: int
...
- name: alteon configuration command
  radware.radware_alteon.alteon_config_static_routes:
    provider:
      server: 192.168.1.1
      user: admin
      password: admin
