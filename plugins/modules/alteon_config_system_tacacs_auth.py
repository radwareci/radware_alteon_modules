...
options:
  ...
  parameters:
    ...
    suboptions:
      ...
      local_user_priority:
        description:
          - Specifies that Alteon should first search for the user in the Local User Table, and only if not
            found/authenticated there to connect to the remote authentication server.
        required: false
        default: disabled
        choices:
        - localFirst
...
- name: alteon configuration command
  radware.radware_alteon.alteon_config_system_tacacs_auth:
    provider:
      server: 192.168.1.1
      user: admin
      password: admin
