...
DOCUMENTATION = r'''
module: alteon_config_snmpv3_group
short_description: Manage SNMPv3 groups in Radware Alteon
description:
  - Manage SNMPv3 group in Radware Alteon.
version_added: '1.0.0'
author:
...
- name: alteon configuration command
  radware.radware_alteon.alteon_config_snmpv3_group:
    provider:
      server: 192.168.1.1
      user: admin
      password: admin
...
class ModuleManager(AlteonConfigurationModule):
    def __init__(self, **kwargs):
        super(ModuleManager, self).__init__(SNMPv3GroupConfigurator, **kwargs)


def main():
    spec = ArgumentSpec(SNMPv3GroupConfigurator)
