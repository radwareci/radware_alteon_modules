...
DOCUMENTATION = r'''
module: alteon_config_group_real_server
short_description: Manage real server in group in Radware Alteon
description:
  - Manage real server in group in Radware Alteon.
version_added: '1.0.0'
author:
...
options:
  ...
  parameters:
    description:
      - Parameters for real server in group.
    type: dict
    suboptions:
      group_index:
        description:
          - The indentifier of the group.
        required: true
        default: null
        type: str
      real_server_index:
        description:
          - The indentifier of the real server.
        required: true
        default: null
        type: str
      real_server_status:
        description:
          - Set the state of the real server.
        required: false
        default: null
        choices:
        - enabled
...
- name: alteon configuration command
  radware.radware_alteon.alteon_config_group_real_server:
    provider:
      server: 192.168.1.1
      user: admin
      password: admin
    ...
    parameters:
      group_index: 3
      real_server_index: 1
      real_server_status: shutdown_connection
'''
...
class ModuleManager(AlteonConfigurationModule):
    def __init__(self, **kwargs):
        super(ModuleManager, self).__init__(GroupRealServerConfigurator, **kwargs)


def main():
    spec = ArgumentSpec(GroupRealServerConfigurator)
